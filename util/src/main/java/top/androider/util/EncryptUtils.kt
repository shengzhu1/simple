...
object EncryptUtils {
    ...
    fun encryptMD2ToString(data: String?): String {
        return if (data == null || data.length == 0) "" else encryptMD2ToString(data.toByteArray())
    }
    ...
    fun encryptMD5ToString(data: String?): String {
        return if (data == null || data.length == 0) "" else encryptMD5ToString(data.toByteArray())
    }
    ...
    fun encryptSHA1ToString(data: String?): String {
        return if (data == null || data.length == 0) "" else encryptSHA1ToString(
            data.toByteArray()
        )
    }
    ...
    fun encryptSHA384ToString(data: String?): String {
        return if (data == null || data.length == 0) "" else encryptSHA384ToString(
            data.toByteArray()
        )
    }
    ...
    fun encryptHmacMD5ToString(data: String?, key: String?): String {
        return if (data == null || data.length == 0 || key == null || key.length == 0) "" else encryptHmacMD5ToString(
            data.toByteArray(),
            key.toByteArray()
        )
    }
    ...
    fun encryptHmacSHA1ToString(data: String?, key: String?): String {
        return if (data == null || data.length == 0 || key == null || key.length == 0) "" else encryptHmacSHA1ToString(
            data.toByteArray(),
            key.toByteArray()
        )
    }
    ...
    fun encryptHmacSHA224ToString(data: String?, key: String?): String {
        return if (data == null || data.length == 0 || key == null || key.length == 0) "" else encryptHmacSHA224ToString(
            data.toByteArray(),
            key.toByteArray()
        )
    }
    ...
    fun encryptHmacSHA256ToString(data: String?, key: String?): String {
        return if (data == null || data.length == 0 || key == null || key.length == 0) "" else encryptHmacSHA256ToString(
            data.toByteArray(),
            key.toByteArray()
        )
    }
    ...
    fun encryptHmacSHA384ToString(data: String?, key: String?): String {
        return if (data == null || data.length == 0 || key == null || key.length == 0) "" else encryptHmacSHA384ToString(
            data.toByteArray(),
            key.toByteArray()
        )
    }
    ...
    fun encryptHmacSHA512ToString(data: String?, key: String?): String {
        return if (data == null || data.length == 0 || key == null || key.length == 0) "" else encryptHmacSHA512ToString(
            data.toByteArray(),
            key.toByteArray()
        )
    }
    ...
    fun decryptBase64RSA(
        ...
        return decryptRSA(EncodeUtils.base64Encode(data), privateKey, keySize, transformation)
    }
    ...
    fun rc4(data: ByteArray?, key: ByteArray?): ByteArray? {
        ...
        for (counter in data.indices) {
            ...
            k = iS[t].toInt()
            ret[counter] = (data[counter] xor k.toByte())
        }
        return ret
    }
