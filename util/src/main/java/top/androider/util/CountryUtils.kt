...
fun getCountryCodeBySim(defaultValue: String): String {
    return countryCodeMap[countryBySim]?:defaultValue
}
/**
...
fun getCountryCodeByLanguage(defaultValue: String): String {
    return countryCodeMap[countryByLanguage]?:defaultValue
}
/**
...
val countryBySim: String
    get() {
        val manager: TelephonyManager? = Utils.app?.getSystemService(android.content.Context.TELEPHONY_SERVICE) as TelephonyManager?
...
val countryByLanguage: String
    get() {
        return android.content.res.Resources.getSystem().configuration.locale.country
    }


private val countryCodeMap by lazy {
